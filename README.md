...
2. **State-Specific Stories** – Each state opens a short video or a story write-up that highlights its unique Diwali celebration.  
3. **Progress Tracker & Progress Bar** – Kids can track how many states they have completed. The quiz unlocks only after all state stories are viewed.  
4. **Lessons Learned Pages** – Each state has a "Lessons Learned" link that takes kids to a bullet-point summary of important facts and learnings from that state's celebration of Diwali.  
5. **Knowledge Quiz (Unlocked by Progress)** – Once all states are explored, kids take a quiz to test their knowledge.  
6. **Global Leaderboard** – Compete for the top spot by earning points in the quiz.  
...
- LinkedIn: [Jonathan's LinkedIn]( www.linkedin.com/in/jonathan-dussot)
## Ashraf Bocktor 
### Role: README & User Testing & Content Creation
...
- Our team also deserves special mention as a whole. We learned a lot from each other, dived headfirst into new technologies, and were helpful in times of need to resolve coding issues.
