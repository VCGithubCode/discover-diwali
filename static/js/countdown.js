class DiwaliCountdown {
	constructor() {
		...
		this.festivalMessages = {
			dhanteras:
				"✨ Welcome to Dhanteras! Today we celebrate new beginnings! Watch for twinkling lights! ✨",
			narakaChaturdasi:
				"🪔 It's Choti Diwali! Time to light beautiful diyas and make rangoli! 🎨",
			lakshmiPuja:
				"🎆 Happy Diwali! Today we celebrate with lights, sweets, and family fun! 🪔",
			govardhanPuja:
				"🌟 Happy Govardhan Puja! Time to thank nature for its gifts! 🌺",
			bhaiDooj:
				"❤️ Happy Bhai Dooj! Celebrating the special bond between brothers and sisters! 🤗",
		};
	...
	update() {
		...
		const currentDates =
			this.diwaliDates[currentYear] || this.diwaliDates[2025];
		...
		if (currentFestival) {
			...
			if (nextDiwali) {
				...
				this.messageEl.textContent =
					"✨ Counting down to the magical festival of Diwali... ✨";
			} else {
